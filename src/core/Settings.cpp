...
bool SettingsManager::Load() {
    ...
    m_settings.fileAutoSaveIntervalMs = ParseInt(L"Editor", L"FileAutoSaveIntervalMs", 30000);
    if (m_settings.fileAutoSaveIntervalMs < 5000) m_settings.fileAutoSaveIntervalMs = 5000;
    if (m_settings.fileAutoSaveIntervalMs > 300000) m_settings.fileAutoSaveIntervalMs = 300000;
...
bool SettingsManager::Save() {
    ...
    WriteInt(L"Editor", L"FileAutoSaveIntervalMs", m_settings.fileAutoSaveIntervalMs);
